...
public final class UiRoundedAtlas {
    ...
    private static void blitCorner(GuiGraphics g, int px, int py, int u, int v, int src, int color) {
        ...
        bb.addVertex(pose, 0, 0, 0).setUv(u0, v0).setColor(cr, cg, cb, ca);
        bb.addVertex(pose, 0, src, 0).setUv(u0, v1).setColor(cr, cg, cb, ca);
        bb.addVertex(pose, src, src, 0).setUv(u1, v1).setColor(cr, cg, cb, ca);
        bb.addVertex(pose, src, 0, 0).setUv(u1, v0).setColor(cr, cg, cb, ca);
    ...
    private static boolean ensure() {
        ...
        try {
            ...
            textureId = ResourceLocation.fromNamespaceAndPath("chatsphere", "ui/rounded_atlas");
