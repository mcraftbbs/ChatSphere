...
public final class Theme {
    ...
    public static int panelBg() {
        return ov(isDark(), "panelBg", 0xDD2A2A4E, 0xDDEAAAF4);
    }

    public static int panelBg2() {
        return ov(isDark(), "panelBg2", 0xDD1E1E3E, 0xDDEAAAF4);
    }
