...
public record ClientboundChatPayload(StoredMessage message)  {
    public static final ResourceLocation ID = new ResourceLocation(ModInfo.MODID, "chat");
    ...
    private static void write(FriendlyByteBuf buf, ClientboundChatPayload p) {
